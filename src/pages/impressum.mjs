...
<section class="page-hero">
  <div class="container">
    ...
    ${kicker("Kolophon · Rechtliches", "k")}
    <h1 class="display ink-title reveal">Impressum</h1>
  </div>
</section>
<section class="section" style="padding-top:clamp(20px,3vw,40px)">
  <div class="container">
    <div class="prose reveal">
      ...
      <p><strong>${SITE.full}</strong><br>[Vor- und Nachname des Inhabers / der Inhaberin]<br>${SITE.street}<br>${SITE.city}<br>Deutschland</p>

      <h2>Kontakt</h2>
      <p>Telefon: <a href="tel:${SITE.phoneHref}">${SITE.phoneDisplay}</a><br>E-Mail: <a href="mailto:${SITE.email}">${SITE.email}</a></p>
      ...
      <p>Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb können wir für diese fremden Inhalte auch keine Gewähr übernehmen. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen.</p>
